 ...
 *          uSDKErrorConst uError = [device execDeviceOperation:cmdList withCmdSN:1000 withGroupCmdName:nil];
 ...
 *          uSDKDeviceAttribute* attr = [[uSDKDeviceAttribute alloc] initWithAttrName:@"201007" withAttrValue:@"201007"];
 *          NSMutableArray* cmdList = [NSMutableArray arrayWithObject:attr];
 *          uSDKErrorInfo* uError = [device execDeviceOperation:cmdList withCmdSN:1000 withGroupName:0];
 *          if (uError.errorNo == RET_USDK_OK) {
 *              NSLog(@"The cmd execute success.");
 *          }
 *      }
 *  </pre>
