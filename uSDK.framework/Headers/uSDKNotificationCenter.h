 ...
 *  </pre>
 */
- (void) subscribeDevice:(id)object
                selector:(SEL) aSelector
             withMacList:(NSArray*) deviceMacList;
 ...
 *  </pre>
 */
- (void) subscribeDeviceListChanged:(id) object
                           selector:(SEL) selector
                     withDeviceType:(uSDKDeviceTypeConst) deviceType;

/**
 *  订阅uSDK内部错误消息
 *
 *  @param object   消息接收对象
 *  @param selector 消息接收方法
 */
- (void) subscribeInnerErrorMessage:(id) object
                           selector:(SEL) selector;
/**
 *	@brief	订阅业务消息
 *
 ...
 *  </pre>
 */
- (void) unSubscribeDevice:(id) object
              withMacList:(NSArray*) deviceMacList;
...
-(void)device:(uSDKDevice*)device didReceiveInfraredInfo:(uSDKTransparentMessage*)infraredInfo;
